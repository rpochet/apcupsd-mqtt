...
def main():
    ...
    status_payload = {"device": {"identifiers": ["apc_ups_" + alias], "manufacturer": "APC", "name": alias, "model": model, "sw_version": firmware}, "unique_id": "apc_ups_" + alias + "_status", "name": "apc_ups_" + alias + "_status", "state_topic": mqtt_topic, "value_template": "{{ value_json.status}}" }
    ...
    linev_payload = {"device_class": "voltage", "device": {"identifiers": ["apc_ups_" + alias], "manufacturer": "APC", "name": alias, "model": model, "sw_version": firmware}, "unique_id": "apc_ups_" + alias + "_linev", "name": "apc_ups_" + alias + "_line_voltage", "state_topic": mqtt_topic, "unit_of_measurement": "V", "value_template": "{{ value_json.linev}}"}
    ...
    loadpct_payload = {"device_class": "power_factor", "device": {"identifiers": ["apc_ups_" + alias], "manufacturer": "APC", "name": alias, "model": model, "sw_version": firmware}, "unique_id": "apc_ups_" + alias + "_loadpct", "name": "apc_ups_" + alias + "_load", "state_topic": mqtt_topic, "unit_of_measurement": "%", "value_template": "{{ value_json.loadpct}}"}
    ...
    bcharge_payload = {"device_class": "battery", "device": {"identifiers": ["apc_ups_" + alias], "manufacturer": "APC", "name": alias, "model": model, "sw_version": firmware}, "unique_id": "apc_ups_" + alias + "_bcharge", "name": "apc_ups_" + alias + "_battery", "state_topic": mqtt_topic, "unit_of_measurement": "%", "value_template": "{{ value_json.bcharge}}"}
    ...
    timeleft_payload = {"device": {"identifiers": ["apc_ups_" + alias], "manufacturer": "APC", "name": alias, "model": model, "sw_version": firmware}, "unique_id": "apc_ups_" + alias + "_timeleft", "name": "apc_ups_" + alias + "_time_remaining", "state_topic": mqtt_topic, "unit_of_measurement": "S", "value_template": "{{ value_json.timeleft}}"}
    ...
    battv_payload = {"device_class": "voltage", "device": {"identifiers": ["apc_ups_" + alias], "manufacturer": "APC", "name": alias, "model": model, "sw_version": firmware}, "unique_id": "apc_ups_" + alias + "_battv", "name": "apc_ups_" + alias + "_battery_voltage", "state_topic": mqtt_topic, "unit_of_measurement": "V", "value_template": "{{ value_json.battv}}"}
    ...
    power_payload = {"device_class": "power", "device": {"identifiers": ["apc_ups_" + alias], "manufacturer": "APC", "name": alias, "model": model, "sw_version": firmware}, "unique_id": "apc_ups_" + alias + "_power", "name": "apc_ups_" + alias + "_power", "state_topic": mqtt_topic, "unit_of_measurement": "W", "value_template": "{{ value_json.power}}"}
